        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-center sm:pt-0">
                    <h1 class="text-gray-900 dark:text-white">WELCOME TO THE BLOG OF LIFE</h1>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-12">
                            ...
                            <div class="flex items-center ml-2">
                                ...
                                <p>
                                    <a href="{{ route('post.view', $post->slug) }}" class="underline text-gray-900 dark:text-white">{{$post->title}}</a>
                                    <small class="text-gray-900 dark:text-white" style="text-align: right">Posted on: {{$post->created_at}}</small>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        Made with ❤️ By Mitchel Ochieng | Laravel   v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                    </div>
                </div>
            </div>
        </div>
